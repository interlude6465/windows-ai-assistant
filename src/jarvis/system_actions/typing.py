...
class TypingActions:
    ...
    def type_text(self, text: str, interval: float = 0.01) -> ActionResult:
        ...
        try:
            ...
            return ActionResult(
                success=False, action_type="type_text", message="Failed to type text", error=str(e)
            )
    ...
    def press_key(self, key: str, presses: int = 1) -> ActionResult:
        ...
        try:
            ...
            return ActionResult(
                success=False, action_type="press_key", message="Failed to press key", error=str(e)
            )
    ...
    def hotkey(self, *keys: str) -> ActionResult:
        ...
        try:
            ...
            return ActionResult(
                success=False, action_type="hotkey", message="Failed to press hotkey", error=str(e)
            )
