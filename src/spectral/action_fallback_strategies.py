"""
Action fallback strategies module for Spectral.
...
from spectral.execution_verifier import VerificationResult
            ...
            for attempt in self.attempts:
                if attempt.verification_result and attempt.verification_result.error_message:
                    ...
                    if "permission" in error_msg or "access denied" in error_msg:
                        recommendations.append(
                            "Run Spectral with elevated/administrator privileges"
                        )
                        break
