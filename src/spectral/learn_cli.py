...
def create_learn_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m spectral.learn --source /path/to/doc.txt
  python -m spectral.learn --source /path/to/doc.pdf --config /path/to/config.yaml
  python -m spectral.learn --source /path/to/doc.md --debug
        """,
    )
