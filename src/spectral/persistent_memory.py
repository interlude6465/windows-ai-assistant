...
from spectral.sqlite_backend import SQLiteBackend
from spectral.storage_backend import MemoryEntry, StorageBackend
...
class MemoryModule:
    ...
    def __init__(
        ...
        if storage_dir:
            ...
            conv_db_path = Path.home() / ".spectral" / "memory" / "conversations.db"
