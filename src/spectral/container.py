...
from spectral.config import ConfigLoader, JarvisConfig
...
from spectral.logging_config import setup_logging
from spectral.memory import MemoryStore
from spectral.memory_rag.rag_service import RAGMemoryService
...
class DualModelManager:
    ...
    def __init__(self, config: JarvisConfig) -> None:
        ...
        Args:
            config: Spectral configuration with dual_llm settings
        """
        self.config = config
