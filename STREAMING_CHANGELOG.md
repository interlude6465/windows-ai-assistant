...
Added streaming support to Spectral chat enabling responses to appear word-by-word as they're generated by the LLM, making the chat interface feel more interactive and responsive.

## Changes Made

### 1. LLMClient (`src/spectral/llm_client.py`)
...
### 2. ChatSession (`src/spectral/chat.py`)
...
1. `src/spectral/llm_client.py` - Added streaming methods
2. `src/spectral/chat.py` - Added streaming support and integrated into chat loop
